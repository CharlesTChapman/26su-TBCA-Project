...
st.title('Welcome to TBCAcademics!')
...
if st.button('Act as Maria, a Student',
             type='primary',
...
if st.button('Act as Cher, a Labor Statistician',
             type='primary',
             use_container_width=True):
    st.session_state['authenticated'] = True
...
if st.button('Act as Zuhal, a Budget Manager',
             type='primary',
             use_container_width=True):
    st.session_state['authenticated'] = True
